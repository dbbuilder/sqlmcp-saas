...
namespace SqlServerMcpFunctions.Domain.Interfaces
{
    ...
    public interface IStoredProcedureExecutor
    {
        ...
        /// <summary>
        /// Get metadata about a stored procedure's parameters
        /// </summary>
        /// <param name="connectionIdentifier">Database connection identifier</param>
        /// <param name="procedureName">Name of the stored procedure</param>
        /// <param name="cancellationToken">Cancellation token</param>
        /// <returns>Collection of parameter metadata</returns>
        Task<IEnumerable<StoredProcedureParameter>> GetParameterMetadataAsync(
            string connectionIdentifier,
            string procedureName,
            CancellationToken cancellationToken = default);
    }
